...
This project uses `solo-main`: single maintainer, commit and push directly to `main`. This is a MANUALLY configured strategy (`strategy_source: manual`) — do not re-offer Strategy Setup here unless the user asks to change the strategy.
