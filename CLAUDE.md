...
| `expert-panel-review` | `expert-panel-review`, `expert-development-team-analysis` | Cross-functional expert panel for refining patterns, Jira artifacts, workflow decisions, and skill drafts before implementation. Keeps Engram-connected learning loop with evidence labels and self-improvement safeguards. |
