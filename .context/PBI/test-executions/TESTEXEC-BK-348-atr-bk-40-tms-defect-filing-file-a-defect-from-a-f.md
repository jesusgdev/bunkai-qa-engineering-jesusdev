# TEST EXECUTION: [ATR] BK-40 — TMS-Defect Filing | File a defect from a failing run step
...
- is executed by: [BK-338](https://jira.upexgalaxy.com/browse/BK-338) - [TC] BK-40-ATP-P1 — Open run-linked defect form (prefilled)
- is executed by: [BK-339](https://jira.upexgalaxy.com/browse/BK-339) - [TC] BK-40-ATP-P2 — Save valid run-linked defect
- is executed by: [BK-340](https://jira.upexgalaxy.com/browse/BK-340) - [TC] BK-40-ATP-P3 — Save standalone defect
- is executed by: [BK-341](https://jira.upexgalaxy.com/browse/BK-341) - [TC] BK-40-ATP-N1 — Non-failed step has no report action
- is executed by: [BK-342](https://jira.upexgalaxy.com/browse/BK-342) - [TC] BK-40-ATP-N2 — Reject invalid title length
- is executed by: [BK-343](https://jira.upexgalaxy.com/browse/BK-343) - [TC] BK-40-ATP-N3 — Reject missing/cross-project module
- is executed by: [BK-344](https://jira.upexgalaxy.com/browse/BK-344) - [TC] BK-40-ATP-N4 — Reject invalid severity
- is executed by: [BK-345](https://jira.upexgalaxy.com/browse/BK-345) - [TC] BK-40-ATP-B1 — Enforce evidence link limit
- is executed by: [BK-346](https://jira.upexgalaxy.com/browse/BK-346) - [TC] BK-40-ATP-I1 — Defect remains TMS-native without Jira sync
