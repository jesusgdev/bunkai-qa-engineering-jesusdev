...
| --- | ----- | ------ | -------- | ------ |
| [BK-2](https://upexgalaxy67.atlassian.net/browse/BK-2) | Sign up and sign in with email (magic-link) | 8 | Medium | Ready For Dev |
| [BK-3](https://upexgalaxy67.atlassian.net/browse/BK-3) | Sign up and sign in via OAuth (GitHub / Google) | 8 | Medium | Ready For Dev |
| [BK-4](https://upexgalaxy67.atlassian.net/browse/BK-4) | Create a Workspace | - | Medium | Shift-Left QA |
| [BK-5](https://upexgalaxy67.atlassian.net/browse/BK-5) | Invite a teammate to a Workspace with role assignment | - | Medium | Shift-Left QA |
| [BK-6](https://upexgalaxy67.atlassian.net/browse/BK-6) | Switch between Workspaces I belong to | - | Medium | Shift-Left QA |
...
_Last sync: 2026-05-27T14:56:43.405Z_
