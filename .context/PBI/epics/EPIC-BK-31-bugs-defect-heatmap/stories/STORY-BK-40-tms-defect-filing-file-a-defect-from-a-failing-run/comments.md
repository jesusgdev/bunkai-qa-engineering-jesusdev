...
### jesusgpythondev - 6/17/2026, 1:24:34 PM
...
## QA Handoff Mirror - [https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40) Shift-Left Review Update

> ***SUCCESS:*** [https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40) is now formatted using the same rich ADF pattern validated by [https://jira.upexgalaxy.com/browse/BK-39#icft=BK-39](https://jira.upexgalaxy.com/browse/BK-39#icft=BK-39) and the [https://jira.upexgalaxy.com/browse/BK-91#icft=BK-91](https://jira.upexgalaxy.com/browse/BK-91#icft=BK-91) formatter showcase: fenced `gherkin` for ACs, visual risk signals, and compact mirror content.

## Executive Summary

[https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40) defines how a QA Engineer files a TMS-native defect from a failed run step, while preserving run context and avoiding duplicate typing. The primary quality concern is context integrity: the saved defect must keep the correct run, step, ATC, module, and evidence references without allowing cross-project leakage.

## Refinement Delta

- ***[ READY ]*** AC format corrected to a fenced `gherkin` block in the AC comment.
- ***[ READY ]*** Expert-panel decisions retained: failed-step-only MVP; standalone filing in scope; Jira sync/file upload out of scope.
- ***[ WATCH ]*** Custom-field REST update is still blocked by env/API mismatch, so AC/ATP remain fallback comments.
- ***[ INFO ]*** This comment is the QA mirror only; full AC and ATP content live in their dedicated fallback comments.
...
[https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40) depends on [https://jira.upexgalaxy.com/browse/BK-35#icft=BK-35](https://jira.upexgalaxy.com/browse/BK-35#icft=BK-35) failed-step state and [https://jira.upexgalaxy.com/browse/BK-70#icft=BK-70](https://jira.upexgalaxy.com/browse/BK-70#icft=BK-70) defect foundation. [https://jira.upexgalaxy.com/browse/BK-41#icft=BK-41](https://jira.upexgalaxy.com/browse/BK-41#icft=BK-41)/[https://jira.upexgalaxy.com/browse/BK-42#icft=BK-42](https://jira.upexgalaxy.com/browse/BK-42#icft=BK-42)/[https://jira.upexgalaxy.com/browse/BK-43#icft=BK-43](https://jira.upexgalaxy.com/browse/BK-43#icft=BK-43) remain downstream and out of scope.
...
- Re-estimation triggers: Jira sync; file upload; blocked/skipped-step filing; expanded permissions; [https://jira.upexgalaxy.com/browse/BK-35#icft=BK-35](https://jira.upexgalaxy.com/browse/BK-35#icft=BK-35) contract change.
...
### jesusgpythondev - 6/17/2026, 1:24:35 PM

## Acceptance Test Plan (ATP) DRAFT - [https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40)

> ***INFO:*** Coverage estimate: Positive 3, Negative 4, Boundary 1, Integration 1, API 0, Total 9.

Rationale: [https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40) is a form-plus-context persistence story with one upstream run-state dependency, validation rules, boundary coverage, and security-relevant project scoping. The ATP stays outline-level because formal TC creation belongs to `/test-documentation` and automation belongs to `/test-automation`.
...
| :green_circle: Low | Jira sync expectation confusion | Explicitly exclude Jira sync from [https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40) | ATP-I1 |
...
- Re-estimation triggers: Jira sync moves into BK-40; file upload enters scope; blocked/skipped step filing enters scope; permission model expands; [https://jira.upexgalaxy.com/browse/BK-35#icft=BK-35](https://jira.upexgalaxy.com/browse/BK-35#icft=BK-35) changes failed-step contract.
- Boundary: QA recommendation only; Jira Story Points / Epic / User Story fields remain canonical unless explicitly requested.

---

### Ely - 7/30/2026, 12:28:13 PM
...
# [https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40) Implementation Plan — TMS-Defect Filing (File a defect from a failing run step)
...
2. ***Bare-bones list scope.*** [https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40) ships an unfiltered, newest-first, single-page list at `/projects/[projectSlug]/bugs` with a "New bug" trigger — zero filter chips/counts/heatmap (those are [https://jira.upexgalaxy.com/browse/BK-41#icft=BK-41](https://jira.upexgalaxy.com/browse/BK-41#icft=BK-41)/BK-42's additive work on the same route). Evidence: master-design-plan.md §4.6's Build order note explicitly assigns filter/count/heatmap to [https://jira.upexgalaxy.com/browse/BK-41#icft=BK-41](https://jira.upexgalaxy.com/browse/BK-41#icft=BK-41)/BK-42; neither mockup shows a "New bug" button anywhere.
3. ***No*** `/bugs/[bugId]` detail page in [https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40). Neither the AC nor comments.md ever test opening a filed bug's detail record. §4.6's Build order note assigns `bug-detail.html` to [https://jira.upexgalaxy.com/browse/BK-43#icft=BK-43](https://jira.upexgalaxy.com/browse/BK-43#icft=BK-43) (sync-status states). The bare list's row shows enough inline to satisfy "immediately visible."
...
5. `bugs.status` gets the full lifecycle enum now (open/in_progress/resolved/closed), even though [https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40) only ever writes `open` — mirrors `runs.status`'s own precedent.
...
9. ***UI integration: a centered modal dialog***, matching the live `RunnerView.tsx`'s existing Abort/Finish modal family, not the mockup's right-side drawer layout — the live runner ([https://jira.upexgalaxy.com/browse/BK-34#icft=BK-34](https://jira.upexgalaxy.com/browse/BK-34#icft=BK-34)/35/36/39) has no reserved right-column slot. Per Critical Rule #14 (live-UI-first).
10. ***No navigation wiring for*** `/bugs` in [https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40](https://jira.upexgalaxy.com/browse/BK-40#icft=BK-40) — matches the already-shipped precedent that `/runs` ([https://jira.upexgalaxy.com/browse/BK-38#icft=BK-38](https://jira.upexgalaxy.com/browse/BK-38#icft=BK-38), live on staging) also has no sidebar link yet.
...
`GET /api/v1/projects/[id]/bugs` — bare list, `auth: required`, no query params ([https://jira.upexgalaxy.com/browse/BK-41#icft=BK-41](https://jira.upexgalaxy.com/browse/BK-41#icft=BK-41) extends additively). Response {{{ items }}}, newest-first.
...
### Automation for Jira - 7/31/2026, 11:38:40 PM

🔎 Pull Request created. Task is pending to ANALYZE and REVIEW by the team. Waiting for PR Approval.

---

### Automation for Jira - 7/31/2026, 11:39:45 PM
